...
export const DAY_ENGINE: DayConfig[] = [
  ...
  {
    id: 1,
    title: "Análise de Crenças",
    subtitle: "Entenda sua relação com o dinheiro",
    objective: "Responda as perguntas para descobrir suas crenças sobre dinheiro e receba um guia personalizado.",
    badge: "15 min",
    emoji: "🧠",
    phase: 'dossie',
    ...
    inputs: [],
    outputMetrics: [
      { key: 'feeling', label: 'Sentimento com dinheiro', format: 'text', icon: '💭' },
      { key: 'emotions_count', label: 'Emoções identificadas', format: 'number', icon: '❤️' },
      { key: 'goals_count', label: 'Objetivos definidos', format: 'number', icon: '🎯' },
      { key: 'schedule', label: 'Horário escolhido', format: 'text', icon: '⏰' },
    ],
    tips: [
      'Seja honesto(a) nas respostas - não há certo ou errado',
      'Suas primeiras memórias revelam muito sobre suas crenças',
      'O guia de reprogramação será baseado nas suas respostas',
    ],
  },
  {
    id: 2,
